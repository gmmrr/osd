#!/usr/bin/env python3
"""Train the shared OSDC architecture without segmentation-3.0 weights."""
...
def run_training(
    *,
    ...
    loader_kwargs = {
        ...
        "pin_memory": selected_accelerator == "cuda",
    }
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train the shared OSDC model from scratch or continue a random-initialized checkpoint.")
...
def main() -> None:
    args = parse_args()
    print(f"🚀 Train random-initialized OSDC in '{args.ground_truth}'")
    print("   • Architecture: shared Model")
    ...
    checkpoint_path = run_training(
        ...
        dataset_root=args.ground_truth,
